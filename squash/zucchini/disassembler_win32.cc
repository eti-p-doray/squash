...
#include "squash/zucchini/abs32_utils.h"
#include "squash/zucchini/algorithm.h"
#include "squash/zucchini/buffer_source.h"
#include "squash/zucchini/rel32_finder.h"
#include "squash/zucchini/rel32_utils.h"
#include "squash/zucchini/reloc_utils.h"
...
bool DisassemblerWin32<Traits>::ParseAndStoreAbs32() {
  ...
  LOG_IF(num_removed, WARNING) << "Found and removed " << num_removed
